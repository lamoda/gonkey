...
- заполнение БД сервиса данными из фикстур (поддерживается PostgreSQL, MySQL)
...
- `-db-type <...>` - тип базы данных. В данный момент поддерживается PostgreSQL, MySQL.
...
func TestFuncCases(t *testing.T) {
  ...
  runner.RunWithTesting(t, &runner.RunWithTestingParams{
    ...
    Mocks:    m,
    DB:       db,
    // Тип используемой базы данных, возможные значения fixtures.Postgres, fixtures.Mysql, fixtures.CustomLoader
